jQuery(document).ready(function($) {
    ...
    console.log('XOPSE Script Loaded');
    ...
    $(document).on('click', '.pse-like-btn', function(e) {
        ...
        $.ajax({
            url: xopse_ajax.ajax_url,
            type: 'POST',
            data: {
                action: 'xopse_handle_like',
                post_id: postId,
                nonce: xopse_ajax.nonce
            },
